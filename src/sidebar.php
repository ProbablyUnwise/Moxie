...
<div id="pagemenus">
    ...
    <div id="mobilemenu">
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="bi bi-person-badge" viewBox="0 0 16 16">
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="bi bi-gear" viewBox="0 0 16 16">
                <path
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="bi bi-journal-richtext" viewBox="0 0 16 16">
                <path
        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="bi bi-chat-left-text" viewBox="0 0 16 16">
                <path
